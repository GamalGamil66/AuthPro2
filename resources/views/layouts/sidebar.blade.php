<div class="sidebar print:hidden">
    ...
    <div class="main-sidebar">
      <div
        class="flex h-full w-full flex-col items-center border-l border-slate-150 bg-white"
      >
        <!-- Application Logo -->
        <div class="flex pt-4">
          <a href="/">
        ...
        >
          ...
          <a
            ...
            class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
        ...
        <div class="flex flex-col items-center space-y-3 py-3">
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="flex items-center space-x-4 space-x-reverse rounded-t-lg bg-slate-100 py-5 px-4"
                >
                ...
                <div class="flex flex-col pt-2 pb-5">
                  <a
                    href="#"
                    class="group flex items-center space-x-3 space-x-reverse py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                  >
                    <div
                  ...
                  <div class="mt-3 px-4">
                    <button
                      class="btn h-9 w-full space-x-2 space-x-reverse bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5"
    ...
    <div class="sidebar-panel">
      <div
        class="flex h-full grow flex-col bg-white pr-[var(--main-sidebar-width)]"
      >
        ...
        >
          <ul class="flex flex-1 flex-col px-4 font-inter">
            <li>
              <a
                x-data="navLink"
                href="/"
                :class="isActive ? 'font-medium text-primary' : 'text-slate-600 hover:text-slate-800'"
          ...
          <ul class="flex flex-1 flex-col px-4 font-inter">
            <li x-data="accordionItem('menu-item-1')">
              <a
                :class="expanded ? 'text-slate-800 font-semibold' : 'text-slate-600 hover:text-slate-800'"
