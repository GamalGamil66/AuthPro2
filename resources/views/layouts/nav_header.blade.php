      ...
      <div class="flex w-full items-center justify-between">
        ...
        <div class="-ml-1.5 flex items-center space-x-2 space-x-reverse">
          ...
          <button
            ...
            class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5.5 w-5.5 text-slate-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="1.5"
            ...
            >
              <div class="relative mr-4 flex h-8">
                <input
                  ...
                  class="form-input peer h-full rounded-full bg-slate-150 px-4 pr-9 text-xs+ text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring"
                ...
                >
                  ...
                  >
                    <button
                      ...
                      :class="activeTab === 'tabAll' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                    ...
                    <button
                      ...
                      :class="activeTab === 'tabFiles' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      Files
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabChats' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      Chats
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabEmails' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      Emails
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabProjects' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      Projects
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabTasks' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      Tasks
                    </button>
                  ...
                  >
                    ...
                    <div class="mt-1 font-inter font-medium">
                      <a
                        class="group flex items-center space-x-2 space-x-reverse px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800"
                        href="apps-chat.html"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <button
              ...
              x-ref="popperRef"
              class="btn relative h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      :class="activeTab === 'tabAlerts' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      <span>Alerts</span>
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabEvents' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      <span>Events</span>
                    </button>
                    <button
                      ...
                      :class="activeTab === 'tabLogs' ? 'border-primary text-primary' : 'border-transparent hover:text-slate-800 focus:text-slate-800'"
                      class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5"
                    >
                      <span>Logs</span>
                    </button>
                ...
                <div class="tab-content flex flex-col overflow-hidden">
                  ...
                  >
                    ...
                    >
                      <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-secondary/10"
                      >
                        <i
                    ...
                    >
                      <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-info/10"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-success/10"
                      >
                    ...
                    >
                      <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-warning/10"
                      >
                    ...
                    >
                      <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-error/10"
                      >
