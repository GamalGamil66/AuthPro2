<div>
    ...
    x-transition.duration @keydown.window.escape="showModal = false"
     @keydown.window.escape="showModal = false">
        ...
        <div class="relative w-full max-w-lg transition-all duration-300 origin-top bg-white rounded-lg"
            ...
            <div class="flex justify-between px-4 py-3 rounded-t-lg bg-slate-200 sm:px-5">
